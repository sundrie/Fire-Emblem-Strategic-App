...
var useOnce=0;var useOnce2=0;$(classes).each(function(i){talents=classes[i].children();talent1=talents[0];talent2=talents[1];imagelink=$(talent1).children()[0];descTalent=$(talent1).children()[1];$("#TalentsList table tbody").append("<tr class="+classes[i].attr("name")+"><td><img src='"+$(imagelink).text()+"'>"+$(talent1).attr("name")+"</td><td>"+$(descTalent).text()+"</td></tr>");imagelink=$(talent2).children()[0];descTalent=$(talent2).children()[1];$("#TalentsList table tbody").append("<tr class="+classes[i].attr("name")+"><td><img src='"+$(imagelink).text()+"'>"+$(talent2).attr("name")+"</td><td>"+$(descTalent).text()+"</td></tr>");if(childTestResult===!0){if((legacyFirstTalent!==undefined)&&(useOnce===0)){var tmp=legacyFirstTalent.split('-');$("#TalentsList table tbody").append("<tr class="+tmp[0]+"><td><img src='https://alexandreblin.ovh/FireEmblemStrategicApp/static/img/talents_icons/"+$.trim(tmp[1])+".png'>"+tmp[1]+"</td><td>"+tmp[2]+"</td></tr>");$("#TalentsList ."+tmp[0]).addClass("drag");useOnce=1}
if((legacySecondTalent!==undefined)&&(useOnce2===0)){var tmp2=legacySecondTalent.split('-');$("#TalentsList table tbody").append("<tr class="+tmp2[0]+"><td><img src='https://alexandreblin.ovh/FireEmblemStrategicApp/static/img/talents_icons/"+$.trim(tmp2[1])+".png'>"+tmp2[1]+"</td><td>"+tmp2[2]+"</td></tr>");$("#TalentsList ."+tmp2[0]).addClass("drag");useOnce2=1}}
...
$(chosenOnes.children('td')).each(function(){encoderforAJAX.push($(this).text())});$.ajax({url:'https://alexandreblin.ovh/FireEmblemStrategicApp/php/savebuild.php',method:'POST',data:{data:encoderforAJAX},success:function(data){window.location.replace("https://alexandreblin.ovh/FireEmblemStrategicApp/php/userdownloadfile.php")}})})}
