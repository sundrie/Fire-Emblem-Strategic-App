<?php
    if($_POST){
        ...
        $destination = imagecreatefromjpeg("https://alexandreblin.ovh/FireEmblemStrategicApp/static/img/background.jpg");

        // On charge d'abord les images
        $source = imagecreatefrompng("https://alexandreblin.ovh/FireEmblemStrategicApp/static/img/character_portrait/".$data[0]."_portrait.png");
        ...
        // La font utilisée le lien est relatif car absolu ça voulait pas (https://alex...)
        ...
        if (isset($data[2])) {
            ...
            $source = imagecreatefrompng("https://alexandreblin.ovh/FireEmblemStrategicApp/static/img/talents_icons/".$nomTalent.".png");
            $largeur_source = imagesx($source);
            $hauteur_source = imagesy($source);
            $destination_x = 185;
        ...
        // Les crédits
        $signature = "Generated by Fire Emblem Strategic App : https://alexandreblin.ovh";
